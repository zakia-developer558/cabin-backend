...
import { create, list, getBySlug, update, remove, listMyCabins } from '../controllers/cabinController.js';
...
router.post('/:slug/book',authenticate, book);
router.post('/:slug/book-multi',authenticate, bookMulti);
